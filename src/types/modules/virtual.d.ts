export interface VirtualMethods {
   ...
   *
   * @note Only for Core version (in React it should be done by modifying slides array/data/source)
   */
...
export interface VirtualOptions {
  ...
  /**
   * Function for external rendering (e.g. using some other library to handle DOM manipulations and state like React.js). As an argument it accepts `data` object with the following properties:
   *
